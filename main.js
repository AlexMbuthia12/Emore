...
document.getElementById("celsius").addEventListener("click", () => {
  updateWeatherInfo("ParkLands", "celsius");
});

document.getElementById("fahr").addEventListener("click", () => {
  updateWeatherInfo("ParkLands", "fahr");
});
...
const products = [
  { title: 'Black Dog',nameId: 'Motina', price: 500, image: 'assets/products/img3.png', isFree: false },
  { title: 'Doomed City',nameId: 'Akon City', price: 100, image: 'assets/products/img2.png', isFree: false },
  { title: 'Space',nameId: 'Astro World', price: 200, image: 'assets/products/img1.png', isFree: false },
  { title: 'Astro Fiction',nameId: 'Allen Crawler', price: 300, image: 'assets/products/img6.png', isFree: false },
  { title: 'My Little Robot',nameId: 'Julia Huggins', price: 0, image: 'assets/products/img5.png', isFree: true },
  { title: 'Garden Girl',nameId: 'Mary Mother', price: 0, image: 'assets/products/img4.png', isFree: true },
];
